...
public class Trend_News_Adapter extends RecyclerView.Adapter<Trend_News_Adapter.ViewHolder> {

    List<News> newsList;
    Context context;

    public Trend_News_Adapter(List<News> newsList, Context context) {
    ...
    @NotNull
    @Override
    public Trend_News_Adapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_trend_fragment_news, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull Trend_News_Adapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.imageview_news_item_trend)
        RoundedImageView imageView_news;
        @BindView(R.id.textview_title_item_trend)
        TextView  textView_title;
        @BindView(R.id.textview_date_item_trend)
